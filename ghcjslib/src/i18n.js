(() => {
  ...
  const LOCALES = {
    es: {
      ...
      HasEqualIfBranches: (binding, must, target, keyword) =>  `${binding} tiene <code>${keyword['if']}</code>s innecesarios porque sus dos ramas son iguales`,
      ...
      HasRedundantIf: (binding, must, target, keyword) => `${binding} tiene <code>${keyword['if']}</code>s innecesarios que pueden ser reemplazados por expresiones booleanas`,
    ...
    en: {
      ...
      HasEqualIfBranches: (binding, must, target, keyword) => `${binding} has unnecessary <code>${keyword['if']}</code> whose branches are equal`,
      ...
      HasRedundantIf: (binding, must, target, keyword) => `${binding} has unnecessary <code>${keyword['if']}</code>s that can be replaced by a boolean expression`,
    ...
    pt: {
      ...
      HasEqualIfBranches: (binding, must, target, keyword) => `${binding} possui <code>${keyword_If}</code>s desnecessários porque seus dois ramos são iguais`,
      ...
      HasRedundantIf: (binding, must, target, keyword) => `${binding} possui <code>${keyword['if']}</code>s desnecessários que podem ser substituídos por expressões booleanas`,
